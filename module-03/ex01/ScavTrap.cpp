...
{
	std::cout << GREEN << "ScavTrap: and they're extra spicy" << RESET << std::endl;
	_health = 100;
	_energy = 50;
	_attack_damage = 20;
}
...
void	ScavTrap::attack(const std::string& target)
	{
		...
		<< " uses it's strong form for violence and attacks " << target \
...
{
	std::cout << MAG << _name << CYN << ": Aint nobody getting past this gate!! 😈" << std::endl;
}
